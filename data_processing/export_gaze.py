...
#%%
# Read and concatinate all surface gaze data files in 001 export folder
files = glob(f'../../Experiment/Data/Pupil data/participant_0*/000/exports/001/surfaces/gaze_positions_on_surface_Monitor.csv')
...
for f in files:
    ...
    dtypes = {'world_index':'uint32','on_surf': 'bool'}
...
subset_mask = [df_total[(df_total.participant_id == t[0]) & (df_total.gaze_timestamp.between(t[5], sum(t[5:])))] \
